/**
 * forge-usecase — Milo C2 block authored by Forge for the Creative Cloud Pro
 * offer "use case" section: a section headline over a bento grid (a 2-up row of
 * app cards, each with an app mnemonic + image + copy, plus one full-width image
 * card with an overlaid mnemonic and copy on a gradient scrim).
 *
